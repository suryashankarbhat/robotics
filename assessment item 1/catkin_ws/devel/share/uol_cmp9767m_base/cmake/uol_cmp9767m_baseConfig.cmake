...
if("TRUE" STREQUAL "TRUE")
  set(uol_cmp9767m_base_SOURCE_PREFIX /home/computing/catkin_ws/src/CMP9767M/uol_cmp9767m_base)
  set(uol_cmp9767m_base_DEVEL_PREFIX /home/computing/catkin_ws/devel)
  ...
  set(uol_cmp9767m_base_INSTALL_PREFIX /home/computing/catkin_ws/install)
...
if(NOT "/usr/include;/usr/include/gazebo-9;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-6.3;/usr/include/ignition/math4;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport4;/usr/include/ignition/msgs1;/usr/include/ignition/common1;/usr/include/ignition/fuel_tools1 " STREQUAL " ")
  set(uol_cmp9767m_base_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include;/usr/include/gazebo-9;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-6.3;/usr/include/ignition/math4;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport4;/usr/include/ignition/msgs1;/usr/include/ignition/common1;/usr/include/ignition/fuel_tools1")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uol_cmp9767m_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/computing/catkin_ws/src/CMP9767M/uol_cmp9767m_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT uol_cmp9767m_base_NUM_DUMMY_TARGETS)
      set(uol_cmp9767m_base_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::uol_cmp9767m_base::wrapped-linker-option${uol_cmp9767m_base_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR uol_cmp9767m_base_NUM_DUMMY_TARGETS "${uol_cmp9767m_base_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::uol_cmp9767m_base::wrapped-linker-option${uol_cmp9767m_base_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND uol_cmp9767m_base_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/computing/catkin_ws/devel/lib;/home/computing/catkin_ws/devel/lib;/opt/ros/melodic/lib)
